...
and Simple Ocean Data Assimilation 3 (SODA3; Carton et al., 2018).

GLORYS12V1:
Overview: https://www.mercator-ocean.fr/wp-content/uploads/2017/06/FS-GLORYS2V4_EN-2.pdf
von Schuckmann, K., and Coauthors, 2016: The Copernicus marine environment monitoring service ocean state report. J. Oper. Oceanogr., 9 (Suppl.), S235–S320, https://doi.org/10.1080/1755876X.2016.1273446.
...
IMPORTANT IF USING GLORYS: In order to calculate the anomaly, you need to process Glorys data using CDO. What I do:
...
IMPORTANT IF USING SODA: In order to calculate the anomaly, you need to process CDO data using CDO. What I do:
...
# Open files.
print('Choose dataset: (1) GLORYS2V4 or (2) SODA3:')
dataset    = input()
if dataset == '1':
...
#sst_mean  = np.nanmean(sst,axis=(1,2,3),dtype='float64')
#ssta_mean = np.nanmean(ssta,axis=(1,2,3),dtype='float64')
